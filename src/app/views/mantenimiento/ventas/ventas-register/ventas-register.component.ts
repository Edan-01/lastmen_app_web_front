    ...
    changerValueFormArray(i: number) {
      ...
      if (obj_1.cantidad > obj_1.stock) {
        Swal.fire({
          position: 'center',
          icon: 'info',
          title: 'La cantidad ingresada es mayor al stock disponible',
          showConfirmButton: false,
          timer: 1650,
        });
        ...
        Swal.fire({
          position: 'center',
          icon: 'info',
          title: 'La cantidad ingresada debe ser mayor a 0',
          showConfirmButton: false,
          timer: 1650,
        });
        obj_1.cantidad = 1;
        ...
        Swal.fire({
          position: 'center',
          icon: 'info',
          title: 'El descuento no puede ser superior al 50% del precio del producto',
          showConfirmButton: false,
          timer: 1650,
        });
        ...
        Swal.fire({
          position: 'center',
          icon: 'info',
          title: 'El descuento ingresado debe ser mayor a 0',
          showConfirmButton: false,
          timer: 1650,
        });
        obj_1.descuento = 0;
